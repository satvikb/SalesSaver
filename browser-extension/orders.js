document.addEventListener(
    ...
    function () {
        ...
        "orders": [
          {
            ...
            "sold_by": "Macy's",
            "description": "multicolor hoodies"
          },
          {
            "delivery_date": "10/10/20 at 2:30PM EST",
            "name": "iPhone 12",
      ...
      function addOrderToDoc(p) {
        ...
        orders_div.innerHTML += `<div class='item' style='display: flex; flex-direction: row; flex-flow: space-between'>
              ...
              <header class='profile-details'>
                ...
                <h3 class='item-msg'>${p.sold_by}</h3>
                <h4 class='item-msg'>${p.description}</h4>
              </div>
            </div>`
