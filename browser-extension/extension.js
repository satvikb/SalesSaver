document.addEventListener(
  ...
  function () {
      ...
      "promotions": [
        {
          ...
          "company": "Macy's",
          "expiration": "9/19/20 at 2:30PM EST"
        },
        {
          ...
          "company": "Apple",
          "expiration": "10/10/20 at 2:30PM EST"
        }
      ]
    }

    console.log(promos, promos.promotions[0].name)

    // document.getElementById("promotions").add

    function addPromotionToDoc(p) {
      var promos_div = document.getElementById("promotions")
      console.log("getting here")
      promos_div.innerHTML += 
          `<div class='item' style='display: flex; flex-direction: row; flex-flow: space-between'>
    ...
    promos.promotions.forEach(p => addPromotionToDoc(p))
  },
  false
);
